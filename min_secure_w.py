...
def find_minimal_secure_w_fast(lam, q, t, w_start, w_step, t_star_min, t_star_max):
    """Log-domain optimized search for the minimal secure w"""
    # Ensure inputs are native Python ints
    ...
    # Precompute log(B(j)) using native floats
    log_B = []
...
find_minimal_secure_w_fast(lam=128, q=127, t=180, w_start=145, w_step=1, t_star_min=1, t_star_max=5)
